...
# %bb.10:                               #   in Loop: Header=BB10_9 Depth=2
	...
	movzbl	(%rcx), %ecx
	addl	%ecx, %esi
	movzbl	1(%r12,%r15), %r15d
	movq	%rax, %rdx
	subq	%r15, %rdx
	movzbl	(%rdx), %ebp
	addl	%ebp, %esi
	movzbl	-1(%r12,%rbx), %edi
	movq	%rax, %rdx
...
# %bb.79:                               #   in Loop: Header=BB17_29 Depth=2
	...
	addl	144(%rsp), %ecx         # 4-byte Folded Reload
	subl	%ecx, %ebx
	addl	%ebp, %ebx
	movl	%ebx, (%rsp)            # 4-byte Spill
	movslq	48(%rsp), %rcx          # 4-byte Folded Reload
	imulq	$-2004318071, %rcx, %rbp # imm = 0x88888889
	shrq	$32, %rbp
	addl	%ebp, %ecx
	movl	%ecx, %ebp
	shrl	$31, %ebp
